...
begin
  ...
  //         количество элементов, кроме вызвавших исключение.
  // Цель 2, взаимоисключающая: перевозбудить исключение, чтобы с ним разбирался код, вызвавший GenerateFooBatch
end.
